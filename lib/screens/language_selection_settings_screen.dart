...
class LanguageSelectionSettingsScreen extends StatefulWidget {
  final bool isFirstTime;

  const LanguageSelectionSettingsScreen({
    super.key,
    this.isFirstTime = false,
  });

  @override
  State<LanguageSelectionSettingsScreen> createState() =>
      _LanguageSelectionSettingsScreenState();
}

class _LanguageSelectionSettingsScreenState
    extends State<LanguageSelectionSettingsScreen> {
